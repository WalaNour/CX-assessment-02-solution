...
// =============> we will use the inheretance in our functions

var Phone = function (phoneNumber) {
  this.phoneNumber = phoneNumber;
};
//we will assign the function send to Phone prototype and it will have the same return
...
var SmartPhone = function (phoneNumber, email) {
  // we will call the Phone function to make sure that 'this' will refer to the same phone
  Phone.call(this, phoneNumber);
  this.email = email;
};
// In case we have more than one function to assign to the same phone we use 'Object.create ()' to inheret all its properties
SmartPhone.prototype = Object.create(Phone.prototype);
SmartPhone.prototype.constructor = SmartPhone;

//we ill refactor the send function and give it a new property which is email and assign it to our SmartPhone
SmartPhone.prototype.send = function (recipientPhoneNumberOrEmail, message) {
  if (typeof recipientPhoneNumberOrEmail === "number") {
    return Phone.prototype.send.call(
      this,
      recipientPhoneNumberOrEmail,
      message
    );
